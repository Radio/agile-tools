    ...
    .config(['$routeProvider', '$routeSegmentProvider', '$locationProvider', 'TEMPLATES_URL',
        function($routeProvider, $routeSegmentProvider, $locationProvider, TEMPLATES_URL) {
            ...
            $routeSegmentProvider
                ...
                .when('/project/:projectKey/:versionName/staffing', 'project.version.staffing')
                    ...
                    .within('project')
                        ...
                        .within('version')
                            ...
                            .segment('staffing', getSegmentParams('Version_Staffing', '/project/version/staffing.html', false, false, ['projectKey', 'versionName']))
                            .up()
                        .up()
                .when('/users', 'users')
